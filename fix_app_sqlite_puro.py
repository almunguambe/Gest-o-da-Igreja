...
# Localiza onde começam as rotas
idx = -1
...
# Substituir leading do reportlab caso ainda exista
rotas = rotas.replace("leading=22", "")

topo_limpo = '''import os
import sqlite3
...
print("✓ app.py restaurado para SQLite puro e ReportLab corrigido!")